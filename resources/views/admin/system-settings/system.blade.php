...
<div class="erp-table-section system-settings min-vh-100">
                                            ...
                                            <div class="tab-pane fade" id="mail-configuration">
                                                <div class="form-group">
                                                    ...
                                                    <select name="QUEUE_MAIL" id="QUEUE_MAIL" class="form-control">
                                                        <option value="true" {{ env('QUEUE_MAIL', 'false') === 'true' ? 'selected' : '' }}>{{ __('true') }}</option>
                                                        <option value="false" {{ env('QUEUE_MAIL', 'false') === 'false' ? 'selected' : '' }}>{{ __('false') }}</option>
                                                    </select>
                                                    <span></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="storage">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="FILESYSTEM_DISK">
                                                        <option value="s3">{{ __('AWS S3 Storage Bucket') }}</option>
                                                        <option value="wasabi">{{ __('Wasabi Storage Bucket') }}</option>
                                                        <option value="public">{{ __('public (uploads folder)') }}</option>
                                                    </select>
                                                    <span></span>
                                                    </div>
                                                </div>
