                    ...
                    <div class="tab-content order-summary-tab p-3">
                        <div class="tab-pane fade show active" id="add-new-user">
                            <div class="order-form-section">
                                <form method="POST" action="{{ route('admin.reporter') }}" enctype="multipart/form-data" class="ajaxform_instant_reload">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mt-3">
                                                ...
                                                <input type="text" class="form-control" name="national_id"
                                                    id="national_id" placeholder="{{ __('National ID') }}" required>
                                            </div>

                                            <div class="col-lg-6 mt-3">
                                                <label>{{ __('Father Name') }}</label>
                                                <input type="text" class="form-control" name="father_name"
                                                    id="father_name" placeholder="{{ __('Father Name') }}" required>
                                            </div>
