                                                ...
                                                <div class="gpt-up-down-arrow position-relative">
                                                    <select class="form-control" name="name" required>
                                                        ...
                                                        <option value="Header 1"
                                                            {{ 'Header 1' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 1') }}</option>
                                                        <option value="Header 2"
                                                            {{ 'Header 2' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 2') }}</option>
                                                        <option value="Header 3"
                                                            {{ 'Header 3' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 3') }}</option>
                                                        <option value="Header 4"
                                                            {{ 'Header 4' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 4') }}</option>
                                                        <option value="Header 5"
                                                            {{ 'Header 5' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 5') }}</option>
                                                        <option value="Header 6"
                                                            {{ 'Header 6' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 6') }}</option>
                                                        <option value="Header 7"
                                                            {{ 'Header 7' == old('name') ? 'selected' : '' }}>
                                                            {{ __('Header 7') }}</option>
                                                    </select>
                                                    <span></span>
                                                </div>
