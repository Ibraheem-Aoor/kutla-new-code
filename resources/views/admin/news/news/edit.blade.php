                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mt-3">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title"
                                                placeholder="{{ __('Enter title') }}" value="{{ $news->title }}" required>
                                        </div>

                                        <div class="col-lg-12 mt-3">
                                            <label>{{ __('Summary') }}</label>
                                            <textarea class="form-control" name="summary" id="summary" placeholder="{{ __('Enter Summary') }}">{{ $news->summary }}</textarea>
                                        </div>

                                        <div class="col-lg-12 mt-3">
                                            <label>{{ __('Description') }}</label>
                                            <textarea class="form-control summernote" name="description" id="summernote"> {{ $news->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mt-3">
                                            <label>{{ __('Tags') }}</label>
                                            <input type="text" class="form-control" name="tags[]" id="tags" placeholder="{{ __('tags') }}" value="{{ $news->tags }}">
                                        </div>
                                        ...
                                        <div class="col-lg-6 mt-3">
                                            ...
                                            <select class="form-control select2bs4" name="reporter_id" id="reporter_id">
                                                ...
                                                @foreach ($newsreporters as $newsreporter)
                                                    <option value="{{ $newsreporter->id }}"@if ($newsreporter->id == $news->reporter_id) selected @endif>
                                                        {{ $newsreporter->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-6 mt-3">
                                            ...
                                            <div class="gpt-up-down-arrow position-relative">
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="1" @selected($news->status == 1)>
                                                        {{ __('Active') }}
                                                    </option>
                                                    <option value="0" @selected($news->status == 0)>
                                                        {{ __('Deactive') }}</option>
                                                </select>
                                                <span></span>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mt-3">
                                            ...
                                            <div class="gpt-up-down-arrow position-relative">
                                                <select name="breaking_news" class="form-control">
                                                    <option value="">{{ __('Select Status') }}</option>
                                                    <option value="1" @selected($news->breaking_news == 1)>
                                                        {{ __('Active') }}
                                                    </option>
                                                    <option value="0" @selected($news->breaking_news == 0)>
                                                        {{ __('Deactive') }}</option>
                                                </select>
                                                <span></span>
                                            </div>
                                                        ...
                                                        @if ($images != '')
                                                            @foreach ($images as $image)
                                                                @if (File::exists($image))
                                                                    <img src="{{ asset($image) }}" class="table-img">
                                                                @endif
                                                            @endforeach
                                                        @endif
                                                    @else
                                        ...
                                        <div class="col-lg-6 mt-3">
                                            ...
                                            <input type="text" class="form-control" name="meta_keyword"
                                                id="meta_keyword" value="{{ $news->meta_keyword }}">
                                        </div>

                                        <div class="col-lg-6 mt-3">
                                            <label for="meta_description">{{ __('Meta Description') }}</label>
                                            <textarea class="form-control" name="meta_description" id="meta_description">{{ $news->meta_description }} </textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
