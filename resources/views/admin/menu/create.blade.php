                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 co-md-8">
                                                    <select  class="form-control" name="name" id="name" required>
                                                        ...
                                                        <option value="Menu 1" {{ "Menu 1" == old('name') ? 'selected' : '' }}>{{__('Menu 1')}}</option>
                                                        <option value="Menu 2" {{ "Menu 2" == old('name') ? 'selected' : '' }}>{{__('Menu 2')}}</option>
                                                        <option value="Menu 3" {{ "Menu 3" == old('name') ? 'selected' : '' }}>{{__('Menu 3')}}</option>
                                                        <option value="Menu 4" {{ "Menu 4" == old('name') ? 'selected' : '' }}>{{__('Menu 4')}}</option>
                                                        <option value="Menu 5" {{ "Menu 5" == old('name') ? 'selected' : '' }}>{{__('Menu 5')}}</option>
                                                        <option value="Menu 6" {{ "Menu 6" == old('name') ? 'selected' : '' }}>{{__('Menu 6')}}</option>
                                                        <option value="Menu 7" {{ "Menu 7" == old('name') ? 'selected' : '' }}>{{__('Menu 7')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
