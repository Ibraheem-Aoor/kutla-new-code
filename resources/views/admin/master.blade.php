...
<head>
    ...
    <title>{{ $settings->title??null }}</title>
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ asset($settings->icon??null) }}" alt="AdminLTELogo" height="60" width="60">
    </div>
...
@if(\Route::current()->getName() != 'admin.dashboard')
    <audio id="myAudio">
        ...
        <source src="{{ asset('audio/notification_up.mp3') }}" type="audio/mp3">
    </audio>
