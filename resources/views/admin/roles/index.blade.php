                            ...
                            <div class="cards shadow border-0 h-100">
                                <div class="row p-4">
                                    ...
                                    <div class="col-sm-7 p-2">
                                        <div class="card-body text-sm-end text-center ps-sm-0 ms-2 p-2">
                                ...
                                <div class="cards shadow border-0">
                                    <div class="card-body p-2">
                                        <div class="d-flex justify-content-between px-2">
                                            ...
                                            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 px-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-end mt-1 pt-25 p-2">
