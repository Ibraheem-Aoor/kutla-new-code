                    ...
                    <div class="col-lg-4">
                        <div class="footer-left">
                            ...
                            <div class="lint-list">
                                <ul>
                                    <li>
                                        <p>{{('Contact us: ')}}@if(get_option('company-info')['email'] ?? false)<a href="mailto:{{ get_option('company-info')['email'] }}">{{ get_option('company-info')['email'] }}</a>@endif</p>
                                    </li>
                                    <li>
                                        <p>{{__('Call us: ')}}@if(get_option('company-info')['phone'] ?? false)<a href="tel:{{get_option('company-info')['phone'] }}">{{ get_option('company-info')['phone'] }}</a>@endif</p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="news10-list-text">
                                        <h4><a href="@if($popularnews->news_categoryslug){{ route('news.details', ['category_name' => $popularnews->news_categoryslug, 'id' => $popularnews->id]) }} @endif">{{ $popularnews->title }}</a></h4>
                                        <ul>
                                            <li>
                                                ...
                                                <span class="news10-item-text text-white">{{ (new \Illuminate\Support\Carbon($popularnews->date))->format('d M, Y') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
