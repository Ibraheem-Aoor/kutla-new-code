                                    ...
                                    <div class="news10-list-text">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span class="news10-item-text text-white">{{ (new \Illuminate\Support\Carbon($popularnews->date))->translatedFormat('d M, Y') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                        ...
                        <div class="news10-email">
                            <form>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control text-white" placeholder="{{ __('Enter Your Email Address') }}" name="email" id="maanEmail">
                                </div>
