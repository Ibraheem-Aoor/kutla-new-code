                                        ...
                                        @if($popularnews->image)
                                            ...
                                            @if($images !='')
                                                @foreach($images as $image)
                                                    <a href="@if($popularnews->news_categoryslug) {{ route('news.details', ['category_name' => $popularnews->news_categoryslug, 'id' => $popularnews->id]) }}@endif">
                                    ...
                                    <div class="news10-list-img">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span class="news10-item-text text-light">{{ (new \Illuminate\Support\Carbon($popularnews->date))->format('d M, Y') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                    ...
                    <div class="news10-email">
                        <form>
                            ...
                            <div class="input-group text-white">
                                ...
                                <input type="email" class="form-control text-white" placeholder="Enter Your Email Address" id="maanEmail">
                            </div>
