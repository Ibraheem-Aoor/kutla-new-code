...
@section('main_content')
    <main>
        ...
        <section class="maan-archive-details maan-slide-section business">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="card maan-default-post">
                            <div class="maan-slide">
                                @foreach ($photogallery->galleryImages as $gallery)
                                    <div class="card maan-default-post">
                                        <div class="maan-post-img">
                                            <a href="#">
                                                <img loading="lazy" src="{{ asset($gallery->image) }}" alt="top-news">
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <span class="maan-item-text"><a
                                                            href="#">{{ $photogallery->reporter_name }}</a></span>
                                                </li>
                                                <li>
                        ...
                        <div class="maan-post-adds">
                            <a href=" @if (advertisement()) {{ advertisement()->leaderboard_url }} @else https://www.google.com/ @endif "
                                target="_blank">
                                <img loading="lazy"
                                    src="
@if (advertisement()) {{ asset(advertisement()->leaderboard_image) }} @else {{ asset('frontend/img/post-add/add.jpg') }} @endif "
                            ...
                            <div class="widgets-gallery">
                                <ul>
                                    ...
                                    @foreach ($photogalleries as $photogallery)
                                        <li>
                                            <a href="{{ route('photogallery.details', $photogallery->id) }}"><img
                            ...
                            <div class="card maan-default-post">
                                <div class="maan-post-img">
                                    <a href="{{ route('photogallery.details', $relatedphotogallery->id) }}">
                                        <img loading="lazy" src="{{ asset($relatedphotogallery->image) }}"
                                            alt="top-news">
                                    </a>
                                ...
                                <div class="card-body maan-card-body">
                                    <div class="maan-text">
                                        <h4><a
                                                href="{{ route('photogallery.details', $relatedphotogallery->id) }}">{{ $relatedphotogallery->title }}</a>
                                        </h4>
                                        <ul>
                                            <li>
                                                <span class="maan-icon">
                                                ...
                                                <span class="maan-item-text"><a
                                                        href="#">{{ $relatedphotogallery->reporter_name }}</a></span>
                                            </li>
                                            <li>
                                                <span class="maan-icon"><svg viewBox="0 0 512 512">
                                                        <path
