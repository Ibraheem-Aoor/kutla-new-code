                            ...
                            <a href="{{ $socials[0]->url }}" target="_blank">
                                ...
                                <div class="maan-text">
                                    ...
                                    <div class="maan-f-numbber"><span
                                            class="counter">{{ $socials[0]->follower }}</span>{{ __('K') }}</div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="follower-btn maan-instagram">
                            <a href="{{ $socials[2]->follower }}" target="_blank">
                                ...
                                <div class="maan-text">
                                    ...
                                    <div class="maan-f-numbber"><span
                                            class="counter">{{ $socials[2]->follower }}</span>{{ __('K') }}</div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="follower-btn maan-twitter">
                            <a href="{{ $socials[1]->url }}">
                                ...
                                <div class="maan-text">
                                    ...
                                    <div class="maan-f-numbber"><span
                                            class="counter">{{ $socials[1]->follower }}</span>{{ __('K') }}</div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="follower-btn maan-youtube">
                            <a href="{{ $socials[4]->url }}" target="_blank">
                                ...
                                <div class="maan-text">
                                    ...
                                    <div class="maan-f-numbber"><span
                                            class="counter">{{ $socials[4]->follower }}</span>{{ __('M') }}</div>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="maan-news-side-add">
                    ...
                    @else
                        <a class=side-add-thumb href="">
                            <img loading="lazy" src="https://towhid.maantheme.com/frontend/img/video-news/big-img-1.jpg"
                                alt="add">
                        </a>
                        <div class="add-text">
                            ...
                            <a href="" class="add-btn">{{ __('Buy Now') }}
                                <svg xmlns="http://www.w3.org/2000/svg" width="9.036" height="13.233"
                                    ...
                                    <path id="Path_4286" data-name="Path 4286" d="M3097.58-672l5.818,5.606-5.818,5.453"
