        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card maan-card-img">
                        <a class="topcategories-thumb" href="  @if(Route::has(strtolower($newscategory->slug)))
                            {{ route('categories.item', ['category_slug' => $newscategory->slug, 'category_name' => $newscategory->name]) }}@endif">

                        <img loading="lazy" src="{{ asset($newscategory->image) }}" alt="{{$newscategory->name}}">

                        </a>
                        <div class="card-body maan-card-body">
                            <a href="  @if(Route::has(strtolower($newscategory->slug))){{ route('categories.item', ['category_slug' => $newscategory->slug, 'category_name' => $newscategory->name]) }}@endif">
                        ...
                        <div class="card maan-big-post">
                                ...
                                @if ($popularnews->image)
                                    ...
                                    @if($images!='')
                                        @foreach ($images as $image)
                                            ...
                                            @endif">
                                                    <img loading="lazy" src="{{ asset($image) }}" alt="{{ __('top-news') }}">
                                                </a>
                                            @endif
                                        @endforeach
                                    @endif
                            ...
                            <div class="card-body maan-card-body pb-0">
                                <div class="maan-text">
                                    <h4>
                                        <a href="@if($popularnews->news_categoryslug)
                                        {{ route('news.details', ['category_name' => $popularnews->news_categoryslug, 'id' => $popularnews->id, 'slug' => Str::slug($popularnews->title)]) }} @endif">{{ $popularnews->title }}
                                        </a>
                                    </h4>
                                    <ul>
                                        <li class="author">
                    ...
                    <div class="news-tab">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link @if ($loop->first) active @endif" id="food-news-tab" data-bs-toggle="pill" data-bs-target="#{{ $popularnewscategory->slug }}" type="button" >{{ $popularnewscategory->name }}</button>
                            </li>
                            @endforeach
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            @foreach($popularnewscategories as $popularnewscategory)
                            <div class="tab-pane fade show  @if ($loop->first) active @endif " id="{{$popularnewscategory->slug}}">
                                            ...
                                            <div class="maan-list-img">
                                                @if ($popularnewsall->image)
                                                    ...
                                                    @if($images!='')
                                                        @foreach ($images as $image)
                                                            @if (File::exists($image))
                                                                <a href="@if($popularnewscategory->slug)
                                                                    {{ route('news.details', ['category_name' => $popularnewscategory->slug, 'id' => $popularnewsall->id, 'slug' => Str::slug($popularnewsall->title)]) }}
                                                            @endif">
                                                                     <img loading="lazy" src="{{ asset($image) }}" alt="{{ asset($image) }}">
                                                                </a>
                                                            @endif
                                            ...
                                            <div class="maan-list-text">
                                                ...
                                                <ul>
                                                    <li class="author">
                                                        ...
                                                        <span class="maan-item-text"><a href="#">{{ $popularnewsall->reporter->first_name }} {{ $popularnewsall->reporter->last_name }}</a></span>
                                                    </li>
                                                    <li class="author-date">
                                                        <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                     ...
                                     @if($lastnewstehnology->image)
                                        ...
                                        @if($images !='')
                                             @foreach($images as $image)
                                                ...
                                                {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewstehnology->id, 'slug' => Str::slug($lastnewstehnology->title)]) }}
                                        @endif">
                                     ...
                                     <div class="maan-text">
                                         ...
                                         <ul>
                                             <li>
                                                 ...
                                                 <span class="maan-item-text"><a href="#">{{ $lastnewstehnology->reporter->first_name }} {{ $lastnewstehnology->reporter->last_name }}</a></span>
                                             </li>
                                             <li>
                                                 <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                ...
                                                @if($loop->iteration<=2)
                                                    <div class="col-lg-6">
                                                        <div class="card maan-default-post">
                                                            <div class="maan-post-img">
                                                                @if($lastnewsentertainment->image)
                                                                    ...
                                                                    @if($images !='')
                                                                        @foreach($images as $image)
                                                                            <a href="@if($newscategory->slug)
                                                                                {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewsentertainment->id, 'slug' => Str::slug($lastnewsentertainment->title)]) }}
                                                                                @endif">
                                                                                <img loading="lazy" src="{{ asset($image) }}" alt="top-news">
                                                                            </a>
                                                                        @endforeach
                                                            ...
                                                            <div class="card-body maan-card-body">
                                                                <div class="maan-text">
                                                                    <h4><a href="@if($newscategory->slug) {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewsentertainment->id, 'slug' => Str::slug($lastnewsentertainment->title)]) }} @endif">{{ $lastnewsentertainment->title }}</a></h4>
                                                                    <ul>
                                                                        <li>
                                                                    <span class="maan-icon">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
                                                                        <g   transform="translate(-24.165)">
                                                                            ...
                                                                            <span class="maan-item-text"><a href="#">{{ $lastnewsentertainment->reporter->first_name }} {{ $lastnewsentertainment->reporter->last_name }}</a></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                                    ...
                                                                    <li>
                                                                        <div class="maan-list-img">
                                                                            @if($lastnewsentertainment->image)
                                                                                ...
                                                                                @if($images !='')
                                                                                    @foreach($images as $image)
                                                                                        <a href="@if($newscategory->slug) {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewsentertainment->id, 'slug' => Str::slug($lastnewsentertainment->title)]) }} @endif">
                                                                                            <img loading="lazy" src="{{ asset($image) }}" alt="top-news">
                                                                                        </a>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="follower-btn maan-facebook">
                                                <a href="{{$socials[0]->url}}" target="_blank">
                                                    ...
                                                    <div class="maan-text">
                                                        <div class="maan-f-text">{{ $page_data['headings']['follower_text_one'] ?? '' }}</div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="follower-btn maan-instagram">
                                                <a href="{{$socials[2]->follower}}" target="_blank">
                                                    ...
                                                    <div class="maan-text">
                                                        <div class="maan-f-text">{{ $page_data['headings']['follower_text_two'] ?? '' }}</div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="follower-btn maan-twitter">
                                                <a href="{{$socials[1]->url}}">
                                                    ...
                                                    <div class="maan-text">
                                                        <div class="maan-f-text">{{ $page_data['headings']['follower_text_three'] ?? '' }}</div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="follower-btn maan-youtube">
                                                <a href="{{$socials[4]->url}}" target="_blank">
                                                    ...
                                                    <div class="maan-text">
                                                        <div class="maan-f-text">{{ $page_data['headings']['follower_text_four'] ?? '' }}</div>
                                    ...
                                    <div class="maan-news-side-add">
                                        ...
                                        @else
                                            <a class=side-add-thumb href="">
                                                <img loading="lazy" src="https://towhid.maantheme.com/frontend/img/video-news/big-img-1.jpg" alt="add">
                                            </a>
                                            <div class="add-text">
                                        ...
                                        <div class="card maan-default-post maansports-big-card">
                                                    ...
                                                    <div class="maan-post-img">
                                                        @if($lastnewssports->image)
                                                            ...
                                                            @if($images !='')
                                                                @foreach($images as $image)
                                                                    <a href="@if($newscategory->slug)
                                                                        {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewssports->id, 'slug' => Str::slug($lastnewssports->title)]) }} @endif">
                                                                        <img loading="lazy" src="{{ asset($image) }}" alt="top-news">
                                                                    </a>
                                                                @endforeach
                                                            @endif
                                                    ...
                                                    <div class="card-body maan-card-body">
                                                        <div class="maan-text">
                                                            <h4 class="m-0">
                                                                <a href="@if($newscategory->slug)
                                                                    {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewssports->id, 'slug' => Str::slug($lastnewssports->title)]) }}
                                                                    @endif">
                                                ...
                                                <g   transform="translate(-24.165)">
                                                    ...
                                                    <g   data-name="Group 467" transform="translate(0)">
                                                        <path   data-name="Path 846" d="M36.147,250.375a3.247,3.247,0,0,0-.35-.639,4.329,4.329,0,0,0-3-1.886.641.641,0,0,0-.441.106,3.712,3.712,0,0,1-4.38,0,.571.571,0,0,0-.441-.106,4.3,4.3,0,0,0-3,1.886,3.743,3.743,0,0,0-.35.639.323.323,0,0,0,.015.289,6.067,6.067,0,0,0,.411.608,5.778,5.778,0,0,0,.7.791,9.112,9.112,0,0,0,.7.608,6.936,6.936,0,0,0,8.274,0,6.685,6.685,0,0,0,.7-.608,7.021,7.021,0,0,0,.7-.791,5.329,5.329,0,0,0,.411-.608A.26.26,0,0,0,36.147,250.375Z" transform="translate(-24.165 -247.841)" fill="#888"/>
                                                                    ...
                                                                    <span class="maan-item-text"><a href="#">{{ $lastnewssports->reporter->first_name }} {{ $lastnewssports->reporter->last_name }}</a></span>
                                                                </li>
                                                                <li>
                                                                    <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                ...
                                <div class="@if($loop->iteration <=2) col-lg-6 politics-news-big-items @else col-lg-4 col-md-6 technologysmall-card-wrp @endif ">
                                    <div class="card maan-default-post">
                                        <div class="maan-post-img">
                                            @if($lastnewspolitics->image)
                                                ...
                                                @if($images !='')
                                                    @foreach($images as $image)
                                                        <a href="@if($newscategory->slug)
                                                            {{ route('news.details', ['category_name' => $newscategory->slug, 'id' => $lastnewspolitics->id, 'slug' => Str::slug($lastnewspolitics->title)]) }}
                                                        @endif">
                                                            <img loading="lazy" src="{{ asset($image) }}" alt="top-news">
                                                        </a>
                                                    @endforeach
                                        ...
                                        <div class="card-body maan-card-body">
                                            <div class="maan-text">
                                                <h4>
                                                    <a href="@if($lastnewspolitics->news_categoryslug)
                                                        {{ route('news.details', ['category_name' => $lastnewspolitics->news_categoryslug, 'id' => $lastnewspolitics->id, 'slug' => Str::slug($lastnewspolitics->title)]) }}
                                                        @endif">
                                            ...
                                            <g  transform="translate(-24.165)">
                                                ...
                                                <g   data-name="Group 467" transform="translate(0)">
                                                    <path   data-name="Path 846" d="M38.619,250.9a3.918,3.918,0,0,0-.422-.771,5.222,5.222,0,0,0-3.614-2.275.773.773,0,0,0-.532.128,4.478,4.478,0,0,1-5.284,0,.688.688,0,0,0-.532-.128,5.185,5.185,0,0,0-3.614,2.275,4.516,4.516,0,0,0-.422.771.39.39,0,0,0,.018.349,7.318,7.318,0,0,0,.5.734,6.97,6.97,0,0,0,.844.954,11,11,0,0,0,.844.734,8.367,8.367,0,0,0,9.981,0,8.065,8.065,0,0,0,.844-.734,8.47,8.47,0,0,0,.844-.954,6.429,6.429,0,0,0,.5-.734A.313.313,0,0,0,38.619,250.9Z" transform="translate(-24.165 -247.841)" fill="#888"/>
                                                        ...
                                                        <span class="maan-item-text"><a href="#">{{ $lastnewspolitics->reporter->first_name }} {{ $lastnewspolitics->reporter->last_name }}</a></span>
                                                    </li>
                                                    <li>
                                                        <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                ...
                <div class="col-lg-2">
                    <div class="card maan-card-img">
                        ...
                        <div class="card-body maan-card-body">
                            ...
                            <div class="maan-text">
                                <h4><a href="{{ route('photogallery.details', ['id'=> $latestphotogallery->id, 'slug'=> Str::slug($latestphotogallery->title)]) }}">{{ $latestphotogallery->title }} <br> {{ __('132.2m') }}</a></h4>
                                <ul>
                                    <li>
                                        <span class="maan-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14.485" height="16.182" viewBox="0 0 14.485 16.182">
