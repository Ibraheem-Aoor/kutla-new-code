    ...
    <div class="header-wrapper p-2">
        ...
        <div class="header-left">
            ...
            <a target="_blank" class="text-custom-primary" href="{{ route('home') }}">
                <div class="view-btn-content d-flex align-items-center justify-content-center gap-2">
                    <img src="{{ asset('assets/images/icons/view-website.svg') }}" alt="">
                      {{ __('View Website') }}
                </div>
            </a>
        </div>
        ...
        <div class="header-right">
            <div class="language-change d-none">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-scrollable shadow">
            ...
            <div class="notifications dropdown">
                ...
                <div class="dropdown-menu shadow">
                    <div class="notification-header bg-white">
